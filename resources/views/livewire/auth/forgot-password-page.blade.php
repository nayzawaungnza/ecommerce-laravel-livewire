                ...
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <a wire:navigate class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="{{route('login')}}">
                                Sign in here
                            </a>
                        </p>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <form wire:submit.prevent='forgotPassword'>
                            @if(session('success'))
                            <div class="my-2 bg-teal-500 text-sm text-white rounded-lg p-4" role="alert">
                                {{session('success')}}
                            </div>
