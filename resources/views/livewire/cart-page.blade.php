                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            <tr wire:key='{{$item['product_id']}}'>
                                ...
                                <td class="py-4">{{Number::currency($item['unit_amount'], 'MMK ')}}</td>
                                <td class="py-4">
                                    <div class="flex items-center">
                                ...
                                <td class="py-4">{{ Number::currency($item['total_amount'], 'MMK ')}}</td>
                                <td>
                            ...
                            @empty
                            <tr>
                                <td colspan='5' class="text-center p4-4 font-semibold text-3xl text-slate-500">No items available in cart!</td>
                            </tr>
                            @endforelse
                            <!-- More product rows -->
                        </tbody>
            ...
            <div class="md:w-1/4">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="flex justify-between mb-2">
                        <span>Subtotal</span>
                        <span>{{Number::currency($grand_total, 'MMK')}}</span>
                    </div>
                    <div class="flex justify-between mb-2">
                        <span>Taxes</span>
                    ...
                    <div class="flex justify-between mb-2">
                        ...
                        <span class="font-semibold">{{Number::currency($grand_total, 'MMK')}}</span>
                    </div>
                    @if($cart_items)
                    <a href="{{route('checkoutRoute')}}" class="bg-blue-500 block text-center text-white py-2 px-4 rounded-lg mt-4 w-full">Checkout</a>
                    @endif
                </div>
            </div>
        </div>
