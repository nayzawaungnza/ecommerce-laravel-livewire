                    ...
                    <div class="lg:pl-20">
                        <div class="mb-8 ">
                            ...
                            <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                <span>{{Number::currency($product->price, 'MMK')}}</span>
                        ...
                        <div class="">
                            ...
                            <div class="block w-full">
                                ...
                                <div class="text">
                                    <div class="hs-tooltip flex items-center justify-start gap-3 md:gap-6 relative mb-6 ">
                                        @foreach($product->colors as $color)

                                        <div class="hs-tooltip">
                                            <button type="button" class="hs-tooltip-toggle p-2 border border-gray-300 rounded-full transition-all duration-300 hover:border-emerald-500">
                                                <svg width="20" height="20" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="20" cy="20" r="20" fill="{{ $color['code'] }}" />
                                                </svg>
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <div class="">
                                ...
                                <div class="relative flex flex-row h-10 mt-6 bg-transparent rounded-lg">
                            ...
                            <div class="  ">
                                <button wire:click='addToCart({{$product->id}})' class="w-full  h-10 mt-6 bg-blue-500 rounded-md dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700">
